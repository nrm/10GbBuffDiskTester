...
/sbin/zpool create -f storage2 raidz /dev/gpt/disk0 /dev/gpt/disk1 /dev/gpt/disk2 /dev/gpt/disk3 /dev/gpt/disk4
/sbin/zpool create -f storage3 raidz /dev/gpt/disk5 /dev/gpt/disk6 /dev/gpt/disk7 /dev/gpt/disk8 /dev/gpt/disk9

/sbin/zpool create -f storage4 raidz /dev/gpt/ssd2d0 /dev/gpt/ssd2d1 /dev/gpt/ssd2d2 /dev/gpt/ssd2d3 /dev/gpt/ssd2d4
/sbin/zpool create -f storage5 raidz /dev/gpt/ssd2d5 /dev/gpt/ssd2d6 /dev/gpt/ssd2d7 /dev/gpt/ssd2d8 /dev/gpt/ssd2d9
/sbin/zpool create -f storage6 raidz /dev/gpt/disk10 /dev/gpt/disk11 /dev/gpt/disk12 /dev/gpt/disk13 /dev/gpt/disk14
